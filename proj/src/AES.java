...
public class AES {
    ...
    private static final int[] MULT_NINE = {
    ...
    private static final int[] MULT_ELEVEN = {
    ...
    private static final int[] MULT_THIRTEEN = {
    ...
    private static final int[] MULT_FOURTEEN = {
    ...
    public String encrypt(){
        ...
        last = encrypted[0] = AESEncryption(IVxor(getIV(),dataArray[0]));
        for(int i = 1;i < dataArray.length; i++ ){
            last = encrypted[i] = AESEncryption(IVxor(last,dataArray[i]));
        }
        String out = arrayToString(encrypted);
        this.cipherText = out;
        return out;
    }
    ...
    public static String[][] AESMixColumnInv(String[][] inStateHex){
        String[][] output = new String[inStateHex.length][inStateHex.length];
        for(int i = 0; i < inStateHex.length; i++){
            for(int j = 0; j < inStateHex.length; j++){
                int num = 0;
    ...
    public static String[][] AESNibbleSubInv(String[][] inStateHex){
        String[][] output = new String[inStateHex.length][inStateHex.length];
        for(int i = 0; i < inStateHex.length; i++){
            for(int j = 0; j < inStateHex[0].length; j++){
                output[i][j] = Integer.toHexString(aesSBoxInv(inStateHex[i][j]));
            }
        }
        return output;
    }
    ...
    public static int evaluateGFInv(String gf, String hex){
        ...
        else if(gf.equals("13"))
            return MULT_THIRTEEN[Integer.parseInt(hex,16)];
        else if(gf.equals("14"))
            return MULT_FOURTEEN[Integer.parseInt(hex,16)];
        else
            return Integer.parseInt(hex,16);
    }
    ...
    public static int aesSBoxInv(String inHex){
        return inverseSBox[Integer.parseInt(inHex,16)];
    }
